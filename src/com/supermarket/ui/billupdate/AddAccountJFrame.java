...
public class AddAccountJFrame extends JFrame implements Runnable{
    ...
    public AddAccountJFrame(JTable jTable) throws SQLException {
        this.setTitle("添加商品");
        ...
        jButton_add.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if(new CheckOfNull().check(jTextField_nameinput.getText())){
                    JOptionPane.showMessageDialog(AddAccountJFrame.this,"商品名称不可为空！");
                }else if(CheckOfNull.check(jTextField_numInput.getText())){
                    JOptionPane.showMessageDialog(AddAccountJFrame.this,"交易数量不可为空！");
                }else if(CheckOfNull.check(jTextField_priceInput.getText())){
                    JOptionPane.showMessageDialog(AddAccountJFrame.this,"交易金额不可为空！");
                }else if(jComboBox_payChoice.getSelectedItem().equals("请选择")){
                    JOptionPane.showMessageDialog(AddAccountJFrame.this,"请选择是否付款！");
                }else if(jComboBox_supplierChoice.getSelectedItem().equals("请选择供应商")){
                    JOptionPane.showMessageDialog(AddAccountJFrame.this,"请选择供应商！");
                }else if(CheckOfNull.check(jTextField_timeInput.getText())){
                    JOptionPane.showMessageDialog(AddAccountJFrame.this,"交易时间不可为空！");
                }else if(!DateStringCheck.isDateString(jTextField_timeInput.getText().trim())){
                    JOptionPane.showMessageDialog(AddAccountJFrame.this,"日期格式不正确！");
                }else{
                    /**预留*/
                    try {
        ...
        /**创建线程，启动线程*/
        Thread threadCheck_account_add =new Thread(this);
        threadCheck_account_add.start();
        this.setVisible(true);
    }

    private boolean insertAccount() throws SQLException {
